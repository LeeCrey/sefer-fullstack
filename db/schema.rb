...
ActiveRecord::Schema[7.0].define(version: 2023_08_08_185741) do
  ...
  create_table "jwt_deny_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["jti", "exp"], name: "index_jwt_deny_lists_on_jti_and_exp"
  ...
  create_table "unwanted_users", force: :cascade do |t|
    t.boolean "blocked", default: false, null: false
    t.bigint "user_id", null: false
    t.integer "unwanted_user_id"
    t.index ["blocked"], name: "index_unwanted_users_on_blocked"
    t.index ["user_id", "unwanted_user_id"], name: "index_unwanted_users_on_user_id_and_unwanted_user_id", unique: true
    t.index ["user_id"], name: "index_unwanted_users_on_user_id"
  end
  ...
  add_foreign_key "unwanted_users", "users"
end
